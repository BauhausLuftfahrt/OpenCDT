...
public class ReportingItemProviderAdapterFactory extends ReportingAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link reporting.ChartWithAxis2D} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected ChartWithAxis2DItemProvider chartWithAxis2DItemProvider;

	/**
	 * This creates an adapter for a {@link reporting.ChartWithAxis2D}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createChartWithAxis2DAdapter() {
		if (chartWithAxis2DItemProvider == null) {
			chartWithAxis2DItemProvider = new ChartWithAxis2DItemProvider(this);
		}

		return chartWithAxis2DItemProvider;
	}
	...
	/**
	 * This keeps track of the one adapter used for all {@link reporting.FontProperties} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected FontPropertiesItemProvider fontPropertiesItemProvider;

	/**
	 * This creates an adapter for a {@link reporting.FontProperties}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createFontPropertiesAdapter() {
		if (fontPropertiesItemProvider == null) {
			fontPropertiesItemProvider = new FontPropertiesItemProvider(this);
		}

		return fontPropertiesItemProvider;
	}

	/**
	 * This keeps track of the one adapter used for all {@link reporting.TextElement} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a {@link reporting.TextElement}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public void dispose() {
		...
		if (chartWithAxis2DItemProvider != null) chartWithAxis2DItemProvider.dispose();
		if (barChartItemProvider != null) barChartItemProvider.dispose();
		if (axisItemProvider != null) axisItemProvider.dispose();
		if (fontPropertiesItemProvider != null) fontPropertiesItemProvider.dispose();
