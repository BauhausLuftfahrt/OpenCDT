		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Axis_Title_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Axis_Title_feature", "_UI_Axis_type"),
				 ReportingPackage.Literals.AXIS__TITLE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addChartPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Axis_Chart_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Axis_Chart_feature", "_UI_Axis_type"),
				 ReportingPackage.Literals.AXIS__CHART,
				 true,
				 false,
				 true,
				 null,
