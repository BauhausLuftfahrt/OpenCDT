...
import formula.impl.FormulaPackageImpl;
...
public class CdtliteraturePackageImpl extends EPackageImpl implements CdtliteraturePackage {
	...
	public static CdtliteraturePackage init() {
		...
		FormulaPackageImpl theFormulaPackage = (FormulaPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(FormulaPackage.eNS_URI) instanceof FormulaPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(FormulaPackage.eNS_URI) : FormulaPackage.eINSTANCE);
	...
	public void initializePackageContents() {
		...
		unpublishedEClass.getESuperTypes().add(this.getALiteratureBase());
