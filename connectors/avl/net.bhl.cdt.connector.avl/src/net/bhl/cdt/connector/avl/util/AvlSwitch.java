 ...
 * @generated
 */
public class AvlSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AvlPackage.AVL: {
				AVL avl = (AVL)theEObject;
				T result = caseAVL(avl);
				if (result == null) result = caseLocalDisciplineTool(avl);
				if (result == null) result = caseDisciplineTool(avl);
				if (result == null) result = caseDesignProcess(avl);
				if (result == null) result = caseProcessElement(avl);
				if (result == null) result = caseNamedElement(avl);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>AVL</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>AVL</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAVL(AVL object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Design Process</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Discipline Tool</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
