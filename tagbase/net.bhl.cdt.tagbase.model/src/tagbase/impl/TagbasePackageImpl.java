...
public class TagbasePackageImpl extends EPackageImpl implements TagbasePackage {
	 ...
	 * @generated
	 */
	private EClass tagableSetEClass = null;
	 ...
	 * @generated
	 */
	public EReference getTagBase_Tables() {
	...
	public EReference getTagBase_TagSets() {
		return (EReference)tagBaseEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EClass getTagableSet() {
		return tagableSetEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getTagableSet_DataItems() {
		return (EReference)tagableSetEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(tagBaseEClass, TAG_BASE__TABLES);
		createEReference(tagBaseEClass, TAG_BASE__TAG_DEFINITIONS);
		createEReference(tagBaseEClass, TAG_BASE__TAG_SETS);

		tagableSetEClass = createEClass(TAGABLE_SET);
		createEReference(tagableSetEClass, TAGABLE_SET__DATA_ITEMS);
	...
	public void initializePackageContents() {
		...
		tagableSetEClass.getESuperTypes().add(this.getAbstractLoggedItem());
		tagableSetEClass.getESuperTypes().add(theModelPackage.getNamedElement());
		...
		initEReference(getTagBase_Tables(), this.getTagableSet(), null, "Tables", null, 0, -1, TagBase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTagBase_TagDefinitions(), this.getNamedTagDefinition(), null, "TagDefinitions", null, 0, -1, TagBase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(tagableSetEClass, TagableSet.class, "TagableSet", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTagableSet_DataItems(), this.getITagable(), null, "DataItems", null, 0, -1, TagableSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
