...
public interface TagbasePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int TAG_BASE__TABLES = ABSTRACT_LOGGED_ITEM_FEATURE_COUNT + 1;

	/**
	 * The feature id for the '<em><b>Tag Definitions</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int TAG_BASE__TAG_DEFINITIONS = ABSTRACT_LOGGED_ITEM_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int TAG_BASE__TAG_SETS = ABSTRACT_LOGGED_ITEM_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int TAG_BASE_FEATURE_COUNT = ABSTRACT_LOGGED_ITEM_FEATURE_COUNT + 4;
	...
	/**
	 * The meta object id for the '{@link tagbase.impl.TagableSetImpl <em>Tagable Set</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see tagbase.impl.TagableSetImpl
	 * @see tagbase.impl.TagbasePackageImpl#getTagableSet()
	 * @generated
	 */
	int TAGABLE_SET = 1;
	 ...
	 * @ordered
	 */
	int TAGABLE_SET__CREATOR = ABSTRACT_LOGGED_ITEM__CREATOR;
	 ...
	 * @ordered
	 */
	int TAGABLE_SET__CREATION_DATE = ABSTRACT_LOGGED_ITEM__CREATION_DATE;
	 ...
	 * @ordered
	 */
	int TAGABLE_SET__LAST_CHANGER = ABSTRACT_LOGGED_ITEM__LAST_CHANGER;
	 ...
	 * @ordered
	 */
	int TAGABLE_SET__LAST_CHANGE_DATE = ABSTRACT_LOGGED_ITEM__LAST_CHANGE_DATE;
	 ...
	 * @ordered
	 */
	int TAGABLE_SET__NAME = ABSTRACT_LOGGED_ITEM_FEATURE_COUNT + 0;

	/**
	 * The feature id for the '<em><b>Data Items</b></em>' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int TAGABLE_SET__DATA_ITEMS = ABSTRACT_LOGGED_ITEM_FEATURE_COUNT + 1;

	/**
	 * The number of structural features of the '<em>Tagable Set</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int TAGABLE_SET_FEATURE_COUNT = ABSTRACT_LOGGED_ITEM_FEATURE_COUNT + 2;

	/**
	 * The number of operations of the '<em>Tagable Set</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int TAGABLE_SET_OPERATION_COUNT = ABSTRACT_LOGGED_ITEM_OPERATION_COUNT + 0;
	...
	/**
	 * Returns the meta object for the reference list '{@link tagbase.TagBase#getTables <em>Tables</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Tables</em>'.
	 * @see tagbase.TagBase#getTables()
	 * @see #getTagBase()
	 * @generated
	 */
	EReference getTagBase_Tables();

	/**
	 * Returns the meta object for the containment reference list '{@link tagbase.TagBase#getTagDefinitions <em>Tag Definitions</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Tag Definitions</em>'.
	...
	/**
	 * Returns the meta object for class '{@link tagbase.TagableSet <em>Tagable Set</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Tagable Set</em>'.
	 * @see tagbase.TagableSet
	 * @generated
	 */
	EClass getTagableSet();

	/**
	 * Returns the meta object for the reference list '{@link tagbase.TagableSet#getDataItems <em>Data Items</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Data Items</em>'.
	 * @see tagbase.TagableSet#getDataItems()
	 * @see #getTagableSet()
	 * @generated
	 */
	EReference getTagableSet_DataItems();
	...
	/**
	 * Returns the meta object for the reference list '{@link tagbase.ITagable#getTags <em>Tags</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference TAG_BASE__TABLES = eINSTANCE.getTagBase_Tables();

		/**
		 * The meta object literal for the '<em><b>Tag Definitions</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		...
		/**
		 * The meta object literal for the '{@link tagbase.impl.TagableSetImpl <em>Tagable Set</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see tagbase.impl.TagableSetImpl
		 * @see tagbase.impl.TagbasePackageImpl#getTagableSet()
		 * @generated
		 */
		EClass TAGABLE_SET = eINSTANCE.getTagableSet();

		/**
		 * The meta object literal for the '<em><b>Data Items</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference TAGABLE_SET__DATA_ITEMS = eINSTANCE.getTagableSet_DataItems();
