...
public class TagbaseAdapterFactory extends AdapterFactoryImpl {
	...
	protected TagbaseSwitch<Adapter> modelSwitch =
		new TagbaseSwitch<Adapter>() {
			...
			@Override
			public Adapter caseTagableSet(TagableSet object) {
				return createTagableSetAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link tagbase.TagableSet <em>Tagable Set</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTagableSetAdapter() {
		return null;
	}
