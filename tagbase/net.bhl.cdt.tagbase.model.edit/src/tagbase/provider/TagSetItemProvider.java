...
/**
 * This is the item provider adapter for a {@link tagbase.TagSet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TagSetItemProvider extends NamedElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public TagSetItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TagbasePackage.Literals.TAG_SET__TAGS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TagSet"));
	}
	...
	public String getText(Object object) {
		String label = ((TagSet)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_TagSet_type") :
			getString("_UI_TagSet_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TagSet.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TagbasePackage.Literals.TAG_SET__TAGS,
				 TagbaseFactory.eINSTANCE.createNamedTag()));
	}
