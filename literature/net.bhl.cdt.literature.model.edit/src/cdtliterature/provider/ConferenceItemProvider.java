...
/**
 * This is the item provider adapter for a {@link cdtliterature.Conference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConferenceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Conference_author_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Conference_author_feature", "_UI_Conference_type"),
				 CdtliteraturePackage.Literals.CONFERENCE__AUTHOR,
				 true,
				 false,
				 false,
	...
	protected void addTitlePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Conference_title_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Conference_title_feature", "_UI_Conference_type"),
				 CdtliteraturePackage.Literals.CONFERENCE__TITLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addBooktitlePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Conference_booktitle_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Conference_booktitle_feature", "_UI_Conference_type"),
				 CdtliteraturePackage.Literals.CONFERENCE__BOOKTITLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addYearPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Conference_year_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Conference_year_feature", "_UI_Conference_type"),
				 CdtliteraturePackage.Literals.CONFERENCE__YEAR,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Conference)object).getAuthor();
