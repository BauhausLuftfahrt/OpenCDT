...
/**
 * This is the item provider adapter for a {@link cdtliterature.Article} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArticleItemProvider extends ALiteratureBaseItemProvider {
	/**
	...
	protected void addJournalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Article_journal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Article_journal_feature", "_UI_Article_type"),
				 CdtliteraturePackage.Literals.ARTICLE__JOURNAL,
				 true,
				 false,
				 false,
