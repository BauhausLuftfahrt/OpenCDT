...
public class DatatypesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case DatatypesPackage.DATA_TYPE: {
			...
			if (result == null)
				result = caseExchangeElement(dataType);
			if (result == null)
		...
		case DatatypesPackage.LEAF_VALUE: {
			...
			if (result == null)
				result = caseExchangeElement(leafValue);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DatatypesPackage.SCALAR: {
			...
			if (result == null)
				result = caseExchangeElement(scalar);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DatatypesPackage.FLOAT_POINT_VALUE: {
			...
			if (result == null)
				result = caseExchangeElement(floatPointValue);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DatatypesPackage.MEASURED_VALUE: {
			...
			if (result == null)
				result = caseExchangeElement(measuredValue);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DatatypesPackage.INTEGER_VALUE: {
			...
			if (result == null)
				result = caseExchangeElement(integerValue);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DatatypesPackage.STRING_VALUE: {
			...
			if (result == null)
				result = caseExchangeElement(stringValue);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DatatypesPackage.FORMULA: {
			...
			if (result == null)
				result = caseExchangeElement(formula);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DatatypesPackage.COMPOSITE_VALUES: {
			...
			if (result == null)
				result = caseExchangeElement(compositeValues);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DatatypesPackage.ARRAY: {
			...
			if (result == null)
				result = caseExchangeElement(array);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DatatypesPackage.CELLS: {
			...
			if (result == null)
				result = caseExchangeElement(cells);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
