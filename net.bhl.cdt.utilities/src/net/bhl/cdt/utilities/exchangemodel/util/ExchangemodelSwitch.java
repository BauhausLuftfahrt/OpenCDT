 ...
 * @generated
 */
public class ExchangemodelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case ExchangemodelPackage.EXCHANGE_ELEMENT: {
		...
		case ExchangemodelPackage.COMPOSITE: {
			...
			if (result == null)
				result = caseExchangeElement(composite);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
