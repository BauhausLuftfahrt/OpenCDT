...
/**
 * This is the item provider adapter for a {@link reporting.Report} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		newChildDescriptors.add
			(createChildParameter
				(ReportingPackage.Literals.REPORT__CHARTS,
				 ReportingFactory.eINSTANCE.createChart3D()));

		newChildDescriptors.add
			(createChildParameter
				(ReportingPackage.Literals.REPORT__CHARTS,
				 ReportingFactory.eINSTANCE.createBarChart()));

		newChildDescriptors.add
			(createChildParameter
				(ReportingPackage.Literals.REPORT__CHARTS,
				 ReportingFactory.eINSTANCE.createGanttChart()));
	}
