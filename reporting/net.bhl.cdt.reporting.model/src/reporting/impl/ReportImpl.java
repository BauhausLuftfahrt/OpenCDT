 ...
 *   <li>{@link reporting.impl.ReportImpl#getDataSourceDefinitions <em>Data Source Definitions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReportImpl extends NamedElementImpl implements Report {
	...
	/**
	 * The cached value of the '{@link #getDataSourceDefinitions() <em>Data Source Definitions</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected EList<DataSourceDefinition> dataSourceDefinitions;
	 ...
	 * @generated
	 */
	public EList<DataSourceDefinition> getDataSourceDefinitions() {
		if (dataSourceDefinitions == null) {
			dataSourceDefinitions = new EObjectContainmentWithInverseEList<DataSourceDefinition>(DataSourceDefinition.class, this, ReportingPackage.REPORT__DATA_SOURCE_DEFINITIONS, ReportingPackage.DATA_SOURCE_DEFINITION__REPORT);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case ReportingPackage.REPORT__DATA_SOURCE_DEFINITIONS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getDataSourceDefinitions()).basicAdd(otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case ReportingPackage.REPORT__DATA_SOURCE_DEFINITIONS:
				return ((InternalEList<?>)getDataSourceDefinitions()).basicRemove(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ReportingPackage.REPORT__CHARTS:
				...
				return;
			case ReportingPackage.REPORT__DATA_SOURCE_DEFINITIONS:
				getDataSourceDefinitions().clear();
				getDataSourceDefinitions().addAll((Collection<? extends DataSourceDefinition>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case ReportingPackage.REPORT__DATA_SOURCE_DEFINITIONS:
				return dataSourceDefinitions != null && !dataSourceDefinitions.isEmpty();
		}
