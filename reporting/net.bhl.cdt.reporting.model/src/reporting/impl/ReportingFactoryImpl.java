...
public class ReportingFactoryImpl extends EFactoryImpl implements ReportingFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ReportingPackage.DATA_FIELD: return createDataField();
			...
			case ReportingPackage.DATA_SOURCE_FILTER: return createDataSourceFilter();
			case ReportingPackage.DATA_SOURCE_GROUPING: return createDataSourceGrouping();
			case ReportingPackage.BUBBLE_CHART: return createBubbleChart();
			default:
	 ...
	 * @generated
	 */
	public DataSourceFilter createDataSourceFilter() {
		DataSourceFilterImpl dataSourceFilter = new DataSourceFilterImpl();
	 ...
	 * @generated
	 */
	public DataSourceGrouping createDataSourceGrouping() {
		DataSourceGroupingImpl dataSourceGrouping = new DataSourceGroupingImpl();
		return dataSourceGrouping;
	}
	...
	public BubbleChart createBubbleChart() {
		BubbleChartImpl bubbleChart = new BubbleChartImpl();
		return bubbleChart;
	}
