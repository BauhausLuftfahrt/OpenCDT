...
public class ReportingSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ReportingPackage.DATA_FIELD: {
			...
			case ReportingPackage.DATA_SOURCE_FILTER: {
				DataSourceFilter dataSourceFilter = (DataSourceFilter)theEObject;
				T result = caseDataSourceFilter(dataSourceFilter);
				if (result == null) result = caseNamedElement(dataSourceFilter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ReportingPackage.DATA_SOURCE_GROUPING: {
				DataSourceGrouping dataSourceGrouping = (DataSourceGrouping)theEObject;
				T result = caseDataSourceGrouping(dataSourceGrouping);
				if (result == null) result = caseNamedElement(dataSourceGrouping);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ReportingPackage.BUBBLE_CHART: {
				BubbleChart bubbleChart = (BubbleChart)theEObject;
				T result = caseBubbleChart(bubbleChart);
				if (result == null) result = caseChart2D(bubbleChart);
				if (result == null) result = caseChart(bubbleChart);
				if (result == null) result = caseReportElement(bubbleChart);
				if (result == null) result = caseNamedElement(bubbleChart);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Data Source Filter</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Data Source Filter</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDataSourceFilter(DataSourceFilter object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Data Source Grouping</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Data Source Grouping</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDataSourceGrouping(DataSourceGrouping object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Bubble Chart</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Bubble Chart</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBubbleChart(BubbleChart object) {
		return null;
	}
