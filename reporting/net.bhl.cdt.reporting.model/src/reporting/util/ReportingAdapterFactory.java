...
public class ReportingAdapterFactory extends AdapterFactoryImpl {
	...
	protected ReportingSwitch<Adapter> modelSwitch =
		new ReportingSwitch<Adapter>() {
			...
			@Override
			public Adapter caseDataSourceFilter(DataSourceFilter object) {
				return createDataSourceFilterAdapter();
			}
			@Override
			public Adapter caseDataSourceGrouping(DataSourceGrouping object) {
				return createDataSourceGroupingAdapter();
			}
			@Override
			public Adapter caseBubbleChart(BubbleChart object) {
				return createBubbleChartAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link reporting.DataField <em>Data Field</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link reporting.DataSourceFilter <em>Data Source Filter</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link reporting.DataSourceGrouping <em>Data Source Grouping</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link reporting.BubbleChart <em>Bubble Chart</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
