 ...
 *   <li>{@link reporting.Report#getDataSourceDefinitions <em>Data Source Definitions</em>}</li>
 * </ul>
 *
...
public interface Report extends NamedElement {
	...
	/**
	 * Returns the value of the '<em><b>Data Source Definitions</b></em>' containment reference list.
	 * The list contents are of type {@link reporting.DataSourceDefinition}.
	 * It is bidirectional and its opposite is '{@link reporting.DataSourceDefinition#getReport <em>Report</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Data Source Definitions</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Data Source Definitions</em>' containment reference list.
	 * @see reporting.ReportingPackage#getReport_DataSourceDefinitions()
	 * @see reporting.DataSourceDefinition#getReport
	 * @model opposite="Report" containment="true" keys="name"
	 * @generated
	 */
	EList<DataSourceDefinition> getDataSourceDefinitions();
