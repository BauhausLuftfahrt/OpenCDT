...
import net.bhl.cdt.assessment.commands.ExportTechnologyGraphToCSVCommand;
 ...
 * @author martin.glas
 */
public class ExportTechnologyGraphToCSVHandler extends AbstractCDTHandler {
	@Override
	public Object doExecute(ExecutionEvent event) throws ExecutionException {
		...
		if (selection instanceof TechnologyElement) {
			new ExportTechnologyGraphToCSVCommand((TechnologyElement) selection).execute();
		}
		return null;
	}
