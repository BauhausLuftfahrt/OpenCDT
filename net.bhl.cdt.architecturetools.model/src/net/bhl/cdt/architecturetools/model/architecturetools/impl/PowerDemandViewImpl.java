 ...
 * <ul>
 * <li>
 * {@link net.bhl.cdt.architecturetools.model.architecturetools.impl.PowerDemandViewImpl#getReferencedConfigurations
...
public class PowerDemandViewImpl extends ViewImpl implements PowerDemandView {
	/**
	 * The cached value of the '{@link #getReferencedConfigurations()
	 * <em>Referenced Configurations</em>}' reference list. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	public EList<Configuration> getReferencedConfigurations() {
		if (referencedConfigurations == null) {
			referencedConfigurations = new EObjectResolvingEList<Configuration>(
					Configuration.class,
					this,
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ArchitecturetoolsPackage.POWER_DEMAND_VIEW__REFERENCED_CONFIGURATIONS:
			...
			getReferencedConfigurations().addAll(
					(Collection<? extends Configuration>) newValue);
			return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case ArchitecturetoolsPackage.POWER_DEMAND_VIEW__REFERENCED_CONFIGURATIONS:
			return referencedConfigurations != null
					&& !referencedConfigurations.isEmpty();
		}
