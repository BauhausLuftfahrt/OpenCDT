...
/**
 * This is the item provider adapter for a {@link formula.Output} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FormulaPackage.Literals.OUTPUT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addRepositoryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Output_repository_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Output_repository_feature", "_UI_Output_type"),
				 FormulaPackage.Literals.OUTPUT__REPOSITORY,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addReferencePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Output_reference_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Output_reference_feature", "_UI_Output_type"),
				 FormulaPackage.Literals.OUTPUT__REFERENCE,
				 true,
				 false,
				 true,
				 null,
