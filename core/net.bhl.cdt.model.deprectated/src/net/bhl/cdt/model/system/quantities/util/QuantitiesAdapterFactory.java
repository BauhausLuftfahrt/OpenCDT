...
public class QuantitiesAdapterFactory extends AdapterFactoryImpl {
	...
	protected QuantitiesSwitch<Adapter> modelSwitch =
		new QuantitiesSwitch<Adapter>() {
			@Override
			public Adapter caseLengthValue(LengthValue object) {
				return createLengthValueAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link net.bhl.cdt.model.system.quantities.LengthValue <em>Length Value</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createLengthValueAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link net.bhl.cdt.model.system.SystemModelElement <em>Model Element</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
