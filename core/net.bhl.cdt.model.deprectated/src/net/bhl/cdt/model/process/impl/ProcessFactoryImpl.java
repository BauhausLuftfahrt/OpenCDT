...
public class ProcessFactoryImpl extends EFactoryImpl implements ProcessFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ProcessPackage.DESIGN_PROCESS: return createDesignProcess();
			default:
	 ...
	 * @generated
	 */
	public DesignProcess createDesignProcess() {
		DesignProcessImpl designProcess = new DesignProcessImpl();
