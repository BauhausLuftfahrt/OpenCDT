 ...
 * @generated
 */
public class ScienceSwitch<T> extends Switch<T> {
        /**
        ...
        protected T doSwitch(int classifierID, EObject theEObject) {
                switch (classifierID) {
                        case SciencePackage.QUANTITY_SET: {
                        ...
                        case SciencePackage.QUANTITY_KIND: {
                        ...
                        case SciencePackage.IDATA_ENTITY: {
                        ...
                        case SciencePackage.IPARAMETER: {
                        ...
                        case SciencePackage.IQUANTIFIED_PARAMETER: {
