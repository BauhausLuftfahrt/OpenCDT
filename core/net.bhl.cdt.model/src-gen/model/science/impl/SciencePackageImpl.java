...
import model.science.ScienceFactory;
 ...
 * @generated
 */
public class SciencePackageImpl extends EPackageImpl implements SciencePackage {
        /**
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         * @generated
         ...
         * @see model.science.SciencePackage#eNS_URI
         * @see #init()
         * @generated
         */
        private SciencePackageImpl() {
                super(eNS_URI, ScienceFactory.eINSTANCE);
        }
         ...
         * 
         * <p>This method is used to initialize {@link SciencePackage#eINSTANCE} when that field is accessed.
         ...
         * @generated
         */
        public static SciencePackage init() {
                if (isInited) return (SciencePackage)EPackage.Registry.INSTANCE.getEPackage(SciencePackage.eNS_URI);

                // Obtain or create and register package
                SciencePackageImpl theSciencePackage = (SciencePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof SciencePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new SciencePackageImpl());
                ...
                theSciencePackage.freeze();

  
                // Update the registry and return the package
                EPackage.Registry.INSTANCE.put(SciencePackage.eNS_URI, theSciencePackage);
                return theSciencePackage;
        }
        ...
        public ScienceFactory getScienceFactory() {
                return (ScienceFactory)getEFactoryInstance();
        }
