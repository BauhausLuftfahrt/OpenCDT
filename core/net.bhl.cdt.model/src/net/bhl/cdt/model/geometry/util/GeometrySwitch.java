...
public class GeometrySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case GeometryPackage.SPACE_VECTOR: {
				SpaceVector spaceVector = (SpaceVector)theEObject;
				T result = caseSpaceVector(spaceVector);
				if (result == null) result = caseValue(spaceVector);
				if (result == null) result = caseSystemModelElement(spaceVector);
				if (result == null) result = caseGeneratableElement(spaceVector);
				if (result == null) result = caseProcessableElement(spaceVector);
				if (result == null) result = caseNamedElement(spaceVector);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Space Vector</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Space Vector</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSpaceVector(SpaceVector object) {
		return null;
	}
