...
public interface IterationNode extends ControlNode {
	/**
	 * Returns the value of the '<em><b>Max Iteration</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link net.bhl.cdt.model.calculation.IterationNode#getMaxIteration <em>Max Iteration</em>}
