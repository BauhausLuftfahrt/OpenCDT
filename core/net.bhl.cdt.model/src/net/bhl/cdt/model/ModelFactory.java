...
public interface ModelFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Discipline View</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>View Link</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
