...
public class ComponentImpl extends StructuralElementImpl implements Component {
	...
	public EList<Component> getSubComponents() {
		if (subComponents == null) {
			subComponents = new EObjectContainmentEList.Resolving<Component>(Component.class, this,
				ModelPackage.COMPONENT__SUB_COMPONENTS);
		}
	...
	public EList<Parameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList.Resolving<Parameter>(Parameter.class, this,
				ModelPackage.COMPONENT__PARAMETERS);
		}
		return parameters;
	}
	...
	public EList<Component> getConnectedComponents() {
		if (connectedComponents == null) {
			connectedComponents = new EObjectResolvingEList<Component>(Component.class, this,
				ModelPackage.COMPONENT__CONNECTED_COMPONENTS);
		}
	...
	public EList<CalculationSet> getCalculationSets() {
		if (calculationSets == null) {
			calculationSets = new EObjectContainmentEList.Resolving<CalculationSet>(CalculationSet.class, this,
				ModelPackage.COMPONENT__CALCULATION_SETS);
		}
	...
	public EList<ComponentInterface> getInterfaces() {
		if (interfaces == null) {
			interfaces = new EObjectContainmentWithInverseEList.Resolving<ComponentInterface>(ComponentInterface.class,
				this, ModelPackage.COMPONENT__INTERFACES, ModelPackage.COMPONENT_INTERFACE__PARENT_COMPONENT);
		}
		return interfaces;
	}
