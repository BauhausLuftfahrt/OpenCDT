 ...
 * <ul>
 *   <li>{@link net.bhl.cdt.model.impl.StateImpl#getValues <em>Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StateImpl extends NamedElementImpl implements State {
	...
	public EList<DataType> getValues() {
		if (values == null) {
			values = new EObjectResolvingEList<DataType>(DataType.class, this, ModelPackage.STATE__VALUES);
		}
		return values;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.STATE__VALUES:
				return getValues();
		}
