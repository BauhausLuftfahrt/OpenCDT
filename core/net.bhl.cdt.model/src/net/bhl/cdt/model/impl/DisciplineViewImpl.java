...
public class DisciplineViewImpl extends ViewImpl implements DisciplineView {
	...
	public EList<StructuralElement> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList.Resolving<StructuralElement>(StructuralElement.class, this,
				ModelPackage.DISCIPLINE_VIEW__ELEMENTS);
		}
		return elements;
	}
	...
	public EList<EClass> getInterfaceTypes() {
		if (interfaceTypes == null) {
			interfaceTypes = new EObjectResolvingEList<EClass>(EClass.class, this,
				ModelPackage.DISCIPLINE_VIEW__INTERFACE_TYPES);
		}
	...
	public EList<ViewLink> getViewLinks() {
		if (viewLinks == null) {
			viewLinks = new EObjectContainmentEList.Resolving<ViewLink>(ViewLink.class, this,
				ModelPackage.DISCIPLINE_VIEW__VIEW_LINKS);
		}
		return viewLinks;
	}
	...
	public EList<View> getSubviews() {
		if (subviews == null) {
			subviews = new EObjectContainmentEList.Resolving<View>(View.class, this,
				ModelPackage.DISCIPLINE_VIEW__SUBVIEWS);
		}
		return subviews;
	}
