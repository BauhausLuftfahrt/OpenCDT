...
public class ModelImpl extends ElementImpl implements Model {
	...
	public EList<Configuration> getConfigurations() {
		if (configurations == null) {
			configurations = new EObjectContainmentEList.Resolving<Configuration>(Configuration.class, this,
				ModelPackage.MODEL__CONFIGURATIONS);
		}
	...
	public EList<QualifyingSpace> getQualifyingSpaces() {
		if (qualifyingSpaces == null) {
			qualifyingSpaces = new EObjectContainmentEList.Resolving<QualifyingSpace>(QualifyingSpace.class, this,
				ModelPackage.MODEL__QUALIFYING_SPACES);
		}
