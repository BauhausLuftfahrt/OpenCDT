...
public abstract class ComponentInterfaceImpl extends ElementImpl implements ComponentInterface {
	...
	public Component getParentComponent() {
		if (eContainerFeatureID() != ModelPackage.COMPONENT_INTERFACE__PARENT_COMPONENT)
			return null;
	...
	public NotificationChain basicSetParentComponent(Component newParentComponent, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newParentComponent,
			ModelPackage.COMPONENT_INTERFACE__PARENT_COMPONENT, msgs);
		return msgs;
	}
	...
	public void setParentComponent(Component newParentComponent) {
		if (newParentComponent != eInternalContainer()
			|| (eContainerFeatureID() != ModelPackage.COMPONENT_INTERFACE__PARENT_COMPONENT && newParentComponent != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.COMPONENT_INTERFACE__PARENT_COMPONENT,
