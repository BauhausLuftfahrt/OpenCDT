...
public class ParameterImpl extends StructuralElementImpl implements Parameter {
	...
	/**
	 * The cached value of the '{@link #getDiscipline() <em>Discipline</em>}' attribute list. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @see #getDiscipline()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getAnnotation() <em>Annotation</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getAnnotation()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getAnnotation() <em>Annotation</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getAnnotation()
	 * @generated
	...
	public void setAnnotation(String newAnnotation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PARAMETER__ANNOTATION, oldAnnotation,
				annotation));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ComponentInterface.class) {
			...
			case ModelPackage.PARAMETER__SOURCE:
				return ModelPackage.COMPONENT_INTERFACE__SOURCE;
			case ModelPackage.PARAMETER__DISCIPLINE:
				return ModelPackage.COMPONENT_INTERFACE__DISCIPLINE;
			case ModelPackage.PARAMETER__ANNOTATION:
				return ModelPackage.COMPONENT_INTERFACE__ANNOTATION;
			default:
				return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ComponentInterface.class) {
			...
			case ModelPackage.COMPONENT_INTERFACE__SOURCE:
				return ModelPackage.PARAMETER__SOURCE;
			case ModelPackage.COMPONENT_INTERFACE__DISCIPLINE:
				return ModelPackage.PARAMETER__DISCIPLINE;
			case ModelPackage.COMPONENT_INTERFACE__ANNOTATION:
				return ModelPackage.PARAMETER__ANNOTATION;
			default:
				return -1;
			}
		}
