...
public class ModelFactoryImpl extends EFactoryImpl implements ModelFactory {
	...
	public static ModelFactory init() {
		try {
			ModelFactory theModelFactory = (ModelFactory)EPackage.Registry.INSTANCE.getEFactory("http://bhl.net/cdt/model"); //$NON-NLS-1$ 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ModelPackage.DISCIPLINE_VIEW: return createDisciplineView();
			case ModelPackage.VIEW_LINK: return createViewLink();
			default:
