 ...
 ******************************************************************************/
package net.bhl.cdt.model.units.util;

import javax.measure.unit.Unit;

import net.bhl.cdt.exceptions.CDTRuntimeException;
import net.bhl.cdt.model.units.Quantity;
import net.bhl.cdt.quantities.Acceleration;
import net.bhl.cdt.quantities.Angle;
import net.bhl.cdt.quantities.Area;
import net.bhl.cdt.quantities.Coefficient;
import net.bhl.cdt.quantities.Density;
import net.bhl.cdt.quantities.Length;
import net.bhl.cdt.quantities.Mass;
import net.bhl.cdt.quantities.SpecificFuelConsumption;
import net.bhl.cdt.quantities.Temperature;
import net.bhl.cdt.quantities.Velocity;
import net.bhl.cdt.quantities.Weight;
