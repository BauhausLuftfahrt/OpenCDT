...
public class ProcessSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ProcessPackage.DESIGN_OPERATION: {
				DesignOperation designOperation = (DesignOperation)theEObject;
				T result = caseDesignOperation(designOperation);
				if (result == null) result = caseProcessElement(designOperation);
				if (result == null) result = caseNamedElement(designOperation);
			...
			case ProcessPackage.DESIGN_PROCESS: {
				DesignProcess designProcess = (DesignProcess)theEObject;
				T result = caseDesignProcess(designProcess);
				if (result == null) result = caseProcessElement(designProcess);
				if (result == null) result = caseNamedElement(designProcess);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
