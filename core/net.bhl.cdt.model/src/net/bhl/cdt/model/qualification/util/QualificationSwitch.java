	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case QualificationPackage.QUALIFIER: {
				...
				if (result == null) result = caseElement(qualifier);
				if (result == null) result = caseExchangeElement(qualifier);
			...
			case QualificationPackage.QUALIFYING_SPACE: {
				...
				if (result == null) result = caseElement(qualifyingSpace);
				if (result == null) result = caseExchangeElement(qualifyingSpace);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QualificationPackage.QUALIFIABLE: {
				...
				if (result == null) result = caseElement(qualifiable);
				if (result == null) result = caseExchangeElement(qualifiable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QualificationPackage.CALCULATION_SPACE: {
				...
				if (result == null) result = caseQualifyingSpace(calculationSpace);
				if (result == null) result = caseElement(calculationSpace);
				if (result == null) result = caseExchangeElement(calculationSpace);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QualificationPackage.CALCULATION_SPACE_QUALIFIER: {
				...
				if (result == null) result = caseQualifier(calculationSpaceQualifier);
				if (result == null) result = caseElement(calculationSpaceQualifier);
				if (result == null) result = caseExchangeElement(calculationSpaceQualifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QualificationPackage.BEHAVIOURAL_SPACE: {
				...
				if (result == null) result = caseQualifyingSpace(behaviouralSpace);
				if (result == null) result = caseElement(behaviouralSpace);
				if (result == null) result = caseExchangeElement(behaviouralSpace);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QualificationPackage.BEHAVIOURAL_QUALIFIER: {
				...
				if (result == null) result = caseQualifier(behaviouralQualifier);
				if (result == null) result = caseElement(behaviouralQualifier);
				if (result == null) result = caseExchangeElement(behaviouralQualifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QualificationPackage.PROCESS: {
				...
				if (result == null) result = caseBehaviouralQualifier(process);
				if (result == null) result = caseQualifier(process);
				if (result == null) result = caseElement(process);
				if (result == null) result = caseExchangeElement(process);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QualificationPackage.STATE: {
				...
				if (result == null) result = caseBehaviouralQualifier(state);
				if (result == null) result = caseQualifier(state);
				if (result == null) result = caseElement(state);
				if (result == null) result = caseExchangeElement(state);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QualificationPackage.SEQUENCE: {
				...
				if (result == null) result = caseBehaviouralQualifier(sequence);
				if (result == null) result = caseQualifier(sequence);
				if (result == null) result = caseElement(sequence);
				if (result == null) result = caseExchangeElement(sequence);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QualificationPackage.TRANSITION: {
				...
				if (result == null) result = caseProcess(transition);
				if (result == null) result = caseBehaviouralQualifier(transition);
				if (result == null) result = caseQualifier(transition);
				if (result == null) result = caseElement(transition);
				if (result == null) result = caseExchangeElement(transition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
