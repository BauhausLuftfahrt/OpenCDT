...
public class ModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ModelPackage.PARAMETER: {
			...
			if (result == null)
				result = caseMappableComponentInterface(parameter);
			if (result == null)
				result = caseComponentInterface(parameter);
			if (result == null)
		...
		case ModelPackage.COMPONENT_INTERFACE: {
			...
			if (result == null)
				result = caseElement(componentInterface);
			if (result == null)
				result = caseExchangeElement(componentInterface);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case ModelPackage.DISCIPLINE_VIEW: {
			DisciplineView disciplineView = (DisciplineView) theEObject;
			T result = caseDisciplineView(disciplineView);
			if (result == null)
				result = caseView(disciplineView);
			if (result == null)
				result = caseElement(disciplineView);
			if (result == null)
				result = caseExchangeElement(disciplineView);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ModelPackage.VIEW_LINK: {
			ViewLink viewLink = (ViewLink) theEObject;
			T result = caseViewLink(viewLink);
			if (result == null)
				result = caseElement(viewLink);
			if (result == null)
				result = caseExchangeElement(viewLink);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ModelPackage.MAPPABLE_COMPONENT_INTERFACE: {
			...
			if (result == null)
				result = caseComponentInterface(mappableComponentInterface);
			if (result == null)
				result = caseElement(mappableComponentInterface);
			if (result == null)
				result = caseExchangeElement(mappableComponentInterface);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Discipline View</em>'. <!-- begin-user-doc
	 * --> This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc
	 * -->
	 * 
	 * @param object the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>View Link</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object the target of the switch.
