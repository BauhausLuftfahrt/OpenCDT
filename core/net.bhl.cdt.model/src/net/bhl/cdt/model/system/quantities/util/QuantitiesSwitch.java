/**
 */
package net.bhl.cdt.model.system.quantities.util;
...
public class QuantitiesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case QuantitiesPackage.LENGTH_VALUE: {
				LengthValue lengthValue = (LengthValue)theEObject;
				T result = caseLengthValue(lengthValue);
				if (result == null) result = caseValue(lengthValue);
				if (result == null) result = caseSystemModelElement(lengthValue);
				if (result == null) result = caseGeneratableElement(lengthValue);
				if (result == null) result = caseProcessableElement(lengthValue);
				if (result == null) result = caseNamedElement(lengthValue);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Length Value</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Length Value</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLengthValue(LengthValue object) {
		return null;
	}
