...
public interface ArchitecturetoolsFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Power Consumer</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Power Demand View</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Massive</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Coefficient Interface</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Wetted Area Interface</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Reference Area Interface</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Altitude Interface</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Range Interface</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>SFC Interface</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
