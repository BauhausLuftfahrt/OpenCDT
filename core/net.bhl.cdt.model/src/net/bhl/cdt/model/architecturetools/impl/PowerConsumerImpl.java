...
/**
 * <!-- begin-user-doc --> An implementation of the model object ' <em><b>Power Consumer</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link net.bhl.cdt.model.architecturetools.impl.PowerConsumerImpl#getPowerParameter <em>Power Parameter</em>}</li>
 * <li>{@link net.bhl.cdt.model.architecturetools.impl.PowerConsumerImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class PowerConsumerImpl extends ComponentInterfaceImpl implements PowerConsumer {
			...
			if (powerParameter != oldPowerParameter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
						ArchitecturetoolsPackage.POWER_CONSUMER__POWER_PARAMETER, oldPowerParameter, powerParameter));
			}
		}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArchitecturetoolsPackage.POWER_CONSUMER__TYPE,
				oldType, type));
	}
