 ...
 * @generated
 */
public class PowerDemandViewItemProvider extends ViewItemProvider implements
	...
	/**
	 * This adds a property descriptor for the Referenced Configurations
	...
	protected void addReferencedConfigurationsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getResourceLocator(),
						getString("_UI_PowerDemandView_referencedConfigurations_feature"),
						getString(
								"_UI_PropertyDescriptor_description",
								"_UI_PowerDemandView_referencedConfigurations_feature",
								"_UI_PowerDemandView_type"),
						ArchitecturetoolsPackage.Literals.POWER_DEMAND_VIEW__REFERENCED_CONFIGURATIONS,
						true, false, true, null, null, null));
	}

	/**
	 * This returns PowerDemandView.gif. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/PowerDemandView"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_PowerDemandView_type")
				: getString("_UI_PowerDemandView_type") + " " + label;
	}
