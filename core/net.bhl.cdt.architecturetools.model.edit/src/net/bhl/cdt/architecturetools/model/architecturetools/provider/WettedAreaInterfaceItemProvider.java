 ...
 * @generated
 */
public class WettedAreaInterfaceItemProvider extends
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addWettedAreaParameterPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Wetted Area Parameter feature.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addWettedAreaParameterPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getResourceLocator(),
						getString("_UI_WettedAreaInterface_wettedAreaParameter_feature"),
						getString(
								"_UI_PropertyDescriptor_description",
								"_UI_WettedAreaInterface_wettedAreaParameter_feature",
								"_UI_WettedAreaInterface_type"),
						ArchitecturetoolsPackage.Literals.WETTED_AREA_INTERFACE__WETTED_AREA_PARAMETER,
						true, false, true, null, null, null));
	}

	/**
	 * This returns WettedAreaInterface.gif. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/WettedAreaInterface"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_WettedAreaInterface_type")
				: getString("_UI_WettedAreaInterface_type") + " " + label;
	}
