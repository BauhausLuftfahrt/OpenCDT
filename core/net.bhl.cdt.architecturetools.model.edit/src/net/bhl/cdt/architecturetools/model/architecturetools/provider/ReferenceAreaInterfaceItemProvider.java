 ...
 * @generated
 */
public class ReferenceAreaInterfaceItemProvider extends
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addReferenceAreaParameterPropertyDescriptor(object);
		}
	...
	protected void addReferenceAreaParameterPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getResourceLocator(),
						getString("_UI_ReferenceAreaInterface_referenceAreaParameter_feature"),
						getString(
								"_UI_PropertyDescriptor_description",
								"_UI_ReferenceAreaInterface_referenceAreaParameter_feature",
								"_UI_ReferenceAreaInterface_type"),
						ArchitecturetoolsPackage.Literals.REFERENCE_AREA_INTERFACE__REFERENCE_AREA_PARAMETER,
						true, false, true, null, null, null));
	}

	/**
	 * This returns ReferenceAreaInterface.gif. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(
				...
				getResourceLocator().getImage(
						"full/obj16/ReferenceAreaInterface"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ReferenceAreaInterface_type")
				: getString("_UI_ReferenceAreaInterface_type") + " " + label;
	}
