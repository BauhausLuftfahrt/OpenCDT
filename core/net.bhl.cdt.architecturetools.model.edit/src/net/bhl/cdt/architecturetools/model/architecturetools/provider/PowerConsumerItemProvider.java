 ...
 * @generated
 */
public class PowerConsumerItemProvider extends ComponentInterfaceItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addPowerParameterPropertyDescriptor(object);
	...
	protected void addPowerParameterPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getResourceLocator(),
						getString("_UI_PowerConsumer_powerParameter_feature"),
						getString("_UI_PropertyDescriptor_description",
								"_UI_PowerConsumer_powerParameter_feature",
								"_UI_PowerConsumer_type"),
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_PowerConsumer_type_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_PowerConsumer_type_feature",
						"_UI_PowerConsumer_type"),
				ArchitecturetoolsPackage.Literals.POWER_CONSUMER__TYPE, true,
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/PowerConsumer"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_PowerConsumer_type")
				: getString("_UI_PowerConsumer_type") + " " + label;
	}
