 ...
 * </p>
 * <ul>
 *   <li>{@link model.data.impl.AValueImpl#getParameter <em>Parameter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AValueImpl extends MinimalEObjectImpl.Container implements AValue {
	/**
	...
	protected EClass eStaticClass() {
		return DataPackage.Literals.AVALUE;
	}
		...
		if (parameter != null && parameter.eIsProxy()) {
			...
			if (parameter != oldParameter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DataPackage.AVALUE__PARAMETER, oldParameter, parameter));
			}
		}
		return parameter;
	}
	...
	public void setParameter(IParameter newParameter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.AVALUE__PARAMETER, oldParameter, parameter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataPackage.AVALUE__PARAMETER:
