...
public class QuantitiesAdapterFactory extends AdapterFactoryImpl {
	...
	protected QuantitiesSwitch<Adapter> modelSwitch =
		new QuantitiesSwitch<Adapter>() {
			...
			@Override
			public Adapter caseINumberParameter(INumberParameter object) {
				return createINumberParameterAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link model.quantities.StringParameter <em>String Parameter</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link model.quantities.INumberParameter <em>INumber Parameter</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createINumberParameterAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link model.quantities.LengthParamenter <em>Length Paramenter</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
