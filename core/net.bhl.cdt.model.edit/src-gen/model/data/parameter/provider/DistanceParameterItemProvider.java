/**
 */
package model.data.parameter.provider;
...
/**
 * This is the item provider adapter for a {@link model.data.parameter.DistanceParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DistanceParameterItemProvider extends ANamedItemItemProvider {
        /**
         ...
         * @generated
         */
        public DistanceParameterItemProvider(AdapterFactory adapterFactory) {
                ...
                itemPropertyDescriptors.add
                        (createItemPropertyDescriptor
                                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                                 ...
                                 DataPackage.Literals.IQUANTIFIED_PARAMETER__VALUE,
                                 true,
                                 false,
                                 false,
                ...
                itemPropertyDescriptors.add
                        (createItemPropertyDescriptor
                                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                                 ...
                                 DataPackage.Literals.IQUANTIFIED_PARAMETER__UNIT,
                                 true,
                                 false,
                                 true,
                                 null,
                ...
                itemPropertyDescriptors.add
                        (createItemPropertyDescriptor
                                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                                 ...
                                 DataPackage.Literals.IQUANTIFIED_PARAMETER__QUANTITY,
                                 true,
                                 false,
                                 true,
                                 null,
        ...
        /**
         * This returns DistanceParameter.gif.
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         * @generated
         */
        ...
        public Object getImage(Object object) {
                return overlayImage(object, getResourceLocator().getImage("full/obj16/DistanceParameter"));
        }
        ...
        public Object getStyledText(Object object) {
                String label = ((DistanceParameter)object).getName();
    	StyledString styledLabel = new StyledString();
                if (label == null || label.length() == 0) {
                        styledLabel.append(getString("_UI_DistanceParameter_type"), StyledString.Style.QUALIFIER_STYLER); 
                } else {
                        styledLabel.append(getString("_UI_DistanceParameter_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label);
                }
                return styledLabel;
        }	
        ...
        public void notifyChanged(Notification notification) {
                ...
                switch (notification.getFeatureID(DistanceParameter.class)) {
