...
public final class ModelEditPlugin extends EMFPlugin {
	...
	public ModelEditPlugin() {
		super(new ResourceLocator[] { BasecalculationmodelEditPlugin.INSTANCE, DatatypesEditPlugin.INSTANCE,
			EcoreEditPlugin.INSTANCE, ExchangemodelEditPlugin.INSTANCE, UnitsEditPlugin.INSTANCE, });
	}
