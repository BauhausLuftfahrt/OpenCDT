...
/**
 * This is the item provider adapter for a {@link net.bhl.cdt.model.calculation.CalculationSetNode} object. <!--
...
public class CalculationSetNodeItemProvider extends AbstractNodeItemProvider implements IEditingDomainItemProvider,
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addCalculationSetPropertyDescriptor(object);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CalculationSetNode")); //$NON-NLS-1$
	}
