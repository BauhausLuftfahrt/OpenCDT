...
/**
 * This is the item provider adapter for a {@link net.bhl.cdt.model.calculation.IterationNode} object. <!--
...
public class IterationNodeItemProvider extends ControlNodeItemProvider implements IEditingDomainItemProvider,
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addMaxIterationPropertyDescriptor(object);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IterationNode")); //$NON-NLS-1$
	}
