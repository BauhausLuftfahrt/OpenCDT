...
/**
 * This is the item provider adapter for a {@link net.bhl.cdt.model.system.Counter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CounterItemProvider extends ValueItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Counter_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Counter_value_feature", "_UI_Counter_type"),
				 SystemPackage.Literals.COUNTER__VALUE,
				 true,
				 false,
				 false,
