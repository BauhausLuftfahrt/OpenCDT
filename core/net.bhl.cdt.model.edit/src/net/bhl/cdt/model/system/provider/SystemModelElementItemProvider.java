...
/**
 * This is the item provider adapter for a {@link net.bhl.cdt.model.system.SystemModelElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SystemModelElementItemProvider 
	 ...
	 * @generated
	 */
	public SystemModelElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((SystemModelElement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SystemModelElement_type") :
			getString("_UI_SystemModelElement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SystemModelElement.class)) {
