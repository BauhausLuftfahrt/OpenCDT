...
/**
 * This is the item provider adapter for a {@link net.bhl.cdt.model.system.QuantityKind} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class QuantityKindItemProvider extends SystemModelElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_QuantityKind_values_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_QuantityKind_values_feature", "_UI_QuantityKind_type"),
				 SystemPackage.Literals.QUANTITY_KIND__VALUES,
				 true,
				 false,
				 true,
				 null,
