...
/**
 * This is the item provider adapter for a {@link net.bhl.cdt.model.qualification.CalculationSpace} object. <!--
...
public class CalculationSpaceItemProvider extends QualifyingSpaceItemProvider implements IEditingDomainItemProvider,
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSpaceQualifierPropertyDescriptor(object);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CalculationSpace")); //$NON-NLS-1$
	}
