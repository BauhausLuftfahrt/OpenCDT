...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>File Parser</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link net.bhl.cdt.connector.files.impl.FileParserImpl#getGeneratedElements <em>Generated Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class FileParserImpl extends FileOperationImpl implements FileParser {
	/**
	...
	public EList<GeneratableElement> getGeneratedElements() {
		if (generatedElements == null) {
			generatedElements = new EObjectContainmentEList<GeneratableElement>(GeneratableElement.class, this, FilesPackage.FILE_PARSER__GENERATED_ELEMENTS);
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == OperationWithOutput.class) {
			switch (derivedFeatureID) {
				case FilesPackage.FILE_PARSER__GENERATED_ELEMENTS: return ModelPackage.OPERATION_WITH_OUTPUT__GENERATED_ELEMENTS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == OperationWithOutput.class) {
			switch (baseFeatureID) {
				case ModelPackage.OPERATION_WITH_OUTPUT__GENERATED_ELEMENTS: return FilesPackage.FILE_PARSER__GENERATED_ELEMENTS;
				default: return -1;
			}
		}
