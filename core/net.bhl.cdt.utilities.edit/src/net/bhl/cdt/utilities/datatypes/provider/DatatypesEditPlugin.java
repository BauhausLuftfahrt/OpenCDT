...
/**
 * This is the central singleton for the Datatypes edit plugin. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public final class DatatypesEditPlugin extends EMFPlugin {
	...
	public DatatypesEditPlugin() {
		super(new ResourceLocator[] { ExchangemodelEditPlugin.INSTANCE, UnitsEditPlugin.INSTANCE, });
	}
