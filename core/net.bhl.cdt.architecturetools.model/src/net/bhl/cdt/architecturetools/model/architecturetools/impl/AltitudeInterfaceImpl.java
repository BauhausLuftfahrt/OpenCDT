 ...
 * <ul>
 * <li>
 * {@link net.bhl.cdt.architecturetools.model.architecturetools.impl.AltitudeInterfaceImpl#getAltitudeParameter
 ...
 * @generated
 */
public class AltitudeInterfaceImpl extends ComponentInterfaceImpl implements
		AltitudeInterface {
	/**
	 * The cached value of the '{@link #getAltitudeParameter()
			...
			if (altitudeParameter != oldAltitudeParameter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							ArchitecturetoolsPackage.ALTITUDE_INTERFACE__ALTITUDE_PARAMETER,
							oldAltitudeParameter, altitudeParameter));
			}
		}
