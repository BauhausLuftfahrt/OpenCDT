 ...
 * </p>
 * 
 * @see net.bhl.cdt.architecturetools.model.architecturetools.ArchitecturetoolsPackage#getCoefficientInterface()
 * @model
 * @generated
 */
public interface CoefficientInterface extends MappableComponentInterface {
	 ...
	 * @see #setType(String)
	 * @see net.bhl.cdt.architecturetools.model.architecturetools.ArchitecturetoolsPackage#getCoefficientInterface_Type()
	 * @model
	 * @generated
	 */
	String getType();
	...
	/**
	 * Returns the value of the '<em><b>Coefficient Parameter</b></em>'
	 * reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Coefficient Parameter</em>' reference isn't
	 ...
	 * @see net.bhl.cdt.architecturetools.model.architecturetools.ArchitecturetoolsPackage#getCoefficientInterface_CoefficientParameter()
	 * @model
	 * @generated
	 */
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Coefficient Parameter</em>'
	 *            reference.
