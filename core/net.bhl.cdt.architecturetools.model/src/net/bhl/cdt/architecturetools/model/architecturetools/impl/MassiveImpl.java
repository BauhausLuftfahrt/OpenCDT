 ...
 * <ul>
 * <li>
 * {@link net.bhl.cdt.architecturetools.model.architecturetools.impl.MassiveImpl#getMassParameter
...
public class MassiveImpl extends ComponentInterfaceImpl implements Massive {
	/**
	 * The cached value of the '{@link #getMassParameter()
			...
			if (massParameter != oldMassParameter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ArchitecturetoolsPackage.MASSIVE__MASS_PARAMETER,
