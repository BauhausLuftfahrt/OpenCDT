 ...
 * @generated
 */
public class ArchitecturetoolsPackageImpl extends EPackageImpl implements
	 ...
	 * @see net.bhl.cdt.architecturetools.model.architecturetools.ArchitecturetoolsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * {@link ArchitecturetoolsPackage#eINSTANCE} when that field is accessed.
	...
	public static ArchitecturetoolsPackage init() {
		if (isInited)
			return (ArchitecturetoolsPackage) EPackage.Registry.INSTANCE
		...
		ArchitecturetoolsPackageImpl theArchitecturetoolsPackage = (ArchitecturetoolsPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof ArchitecturetoolsPackageImpl ? EPackage.Registry.INSTANCE
				.get(eNS_URI) : new ArchitecturetoolsPackageImpl());
		...
		EPackage.Registry.INSTANCE.put(ArchitecturetoolsPackage.eNS_URI,
	...
	public EReference getPowerDemandView_ReferencedConfigurations() {
		return (EReference) powerDemandViewEClass.getEStructuralFeatures().get(
				0);
	}
	...
	public EAttribute getCoefficientInterface_Type() {
		return (EAttribute) coefficientInterfaceEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EReference getCoefficientInterface_CoefficientParameter() {
		return (EReference) coefficientInterfaceEClass.getEStructuralFeatures()
				.get(1);
	}
	...
	public EReference getWettedAreaInterface_WettedAreaParameter() {
		return (EReference) wettedAreaInterfaceEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EReference getReferenceAreaInterface_ReferenceAreaParameter() {
		return (EReference) referenceAreaInterfaceEClass
	...
	public EReference getAltitudeInterface_AltitudeParameter() {
		return (EReference) altitudeInterfaceEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EReference getRangeInterface_RangeParameter() {
		return (EReference) rangeInterfaceEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(powerDemandViewEClass,
				POWER_DEMAND_VIEW__REFERENCED_CONFIGURATIONS);
		...
		createEAttribute(coefficientInterfaceEClass,
				COEFFICIENT_INTERFACE__TYPE);
		createEReference(coefficientInterfaceEClass,
				COEFFICIENT_INTERFACE__COEFFICIENT_PARAMETER);

		wettedAreaInterfaceEClass = createEClass(WETTED_AREA_INTERFACE);
		createEReference(wettedAreaInterfaceEClass,
				WETTED_AREA_INTERFACE__WETTED_AREA_PARAMETER);

		referenceAreaInterfaceEClass = createEClass(REFERENCE_AREA_INTERFACE);
		createEReference(referenceAreaInterfaceEClass,
				REFERENCE_AREA_INTERFACE__REFERENCE_AREA_PARAMETER);

		altitudeInterfaceEClass = createEClass(ALTITUDE_INTERFACE);
		createEReference(altitudeInterfaceEClass,
				ALTITUDE_INTERFACE__ALTITUDE_PARAMETER);
	...
	public void initializePackageContents() {
		...
		powerConsumerEClass.getESuperTypes().add(
				theModelPackage.getMappableComponentInterface());
		powerDemandViewEClass.getESuperTypes().add(theModelPackage.getView());
		massiveEClass.getESuperTypes().add(
				theModelPackage.getMappableComponentInterface());
		coefficientInterfaceEClass.getESuperTypes().add(
				theModelPackage.getMappableComponentInterface());
		wettedAreaInterfaceEClass.getESuperTypes().add(
				theModelPackage.getMappableComponentInterface());
		referenceAreaInterfaceEClass.getESuperTypes().add(
				theModelPackage.getMappableComponentInterface());
		altitudeInterfaceEClass.getESuperTypes().add(
				theModelPackage.getMappableComponentInterface());
		rangeInterfaceEClass.getESuperTypes().add(
				theModelPackage.getMappableComponentInterface());
		sfcInterfaceEClass.getESuperTypes().add(
				theModelPackage.getMappableComponentInterface());

		// Initialize classes and features; add operations and parameters
		initEClass(powerConsumerEClass, PowerConsumer.class, "PowerConsumer",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPowerConsumer_PowerParameter(),
				theModelPackage.getParameter(), null, "powerParameter", null,
				0, 1, PowerConsumer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPowerConsumer_Type(), ecorePackage.getEString(),
				"type", null, 0, 1, PowerConsumer.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		addEOperation(powerConsumerEClass, theModelPackage.getValue(),
				"getPowerConsumption", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(powerDemandViewEClass, PowerDemandView.class,
				"PowerDemandView", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPowerDemandView_ReferencedConfigurations(),
				theModelPackage.getConfiguration(), null,
				"referencedConfigurations", null, 0, -1, PowerDemandView.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(massiveEClass, Massive.class, "Massive", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMassive_MassParameter(),
				theModelPackage.getParameter(), null, "massParameter", null, 0,
				1, Massive.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		addEOperation(massiveEClass, theModelPackage.getValue(), "getMass", 0,
				1, IS_UNIQUE, IS_ORDERED);

		initEClass(coefficientInterfaceEClass, CoefficientInterface.class,
				"CoefficientInterface", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCoefficientInterface_Type(),
				theEcorePackage.getEString(), "type", null, 0, 1,
				CoefficientInterface.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getCoefficientInterface_CoefficientParameter(),
				theModelPackage.getParameter(), null, "coefficientParameter",
				null, 0, 1, CoefficientInterface.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		addEOperation(coefficientInterfaceEClass, theModelPackage.getValue(),
				"getCoefficient", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(wettedAreaInterfaceEClass, WettedAreaInterface.class,
				"WettedAreaInterface", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getWettedAreaInterface_WettedAreaParameter(),
				theModelPackage.getParameter(), null, "wettedAreaParameter",
				null, 0, 1, WettedAreaInterface.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		addEOperation(wettedAreaInterfaceEClass, theModelPackage.getValue(),
				"getWettedArea", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(referenceAreaInterfaceEClass, ReferenceAreaInterface.class,
				"ReferenceAreaInterface", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getReferenceAreaInterface_ReferenceAreaParameter(),
				theModelPackage.getParameter(), null, "referenceAreaParameter",
				null, 0, 1, ReferenceAreaInterface.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		addEOperation(referenceAreaInterfaceEClass, theModelPackage.getValue(),
				"getReferenceArea", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(altitudeInterfaceEClass, AltitudeInterface.class,
				"AltitudeInterface", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAltitudeInterface_AltitudeParameter(),
				theModelPackage.getParameter(), null, "altitudeParameter",
				null, 0, 1, AltitudeInterface.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		addEOperation(altitudeInterfaceEClass, theModelPackage.getValue(),
				"getAltitude", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(rangeInterfaceEClass, RangeInterface.class,
				"RangeInterface", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRangeInterface_RangeParameter(),
				theModelPackage.getParameter(), null, "rangeParameter", null,
				0, 1, RangeInterface.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		addEOperation(rangeInterfaceEClass, theModelPackage.getValue(),
				"getRange", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(sfcInterfaceEClass, SFCInterface.class, "SFCInterface",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSFCInterface_SFCParameter(),
				theModelPackage.getParameter(), null, "SFCParameter", null, 0,
				1, SFCInterface.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		addEOperation(sfcInterfaceEClass, theModelPackage.getValue(), "getSFC",
