 ...
 * <em><b>Range Interface</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link net.bhl.cdt.architecturetools.model.architecturetools.impl.RangeInterfaceImpl#getRangeParameter
 * <em>Range Parameter</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
 */
public class RangeInterfaceImpl extends ComponentInterfaceImpl implements
		RangeInterface {
	/**
	 * The cached value of the '{@link #getRangeParameter()
	 * <em>Range Parameter</em>}' reference. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
			...
			if (rangeParameter != oldRangeParameter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							ArchitecturetoolsPackage.RANGE_INTERFACE__RANGE_PARAMETER,
							oldRangeParameter, rangeParameter));
			}
		}
	...
	public Value getValue(CalculationSpaceQualifier calcSpaceQualifier) {
		...
		for (Value value : rangeParameter.getValues()) {
