...
import net.bhl.cdt.ui.e4.parts.explorer.provider.ExplorerViewContentProvider;
import net.bhl.cdt.ui.e4.parts.explorer.provider.FileModifiedLabelProvider;
import net.bhl.cdt.ui.e4.parts.explorer.provider.FileSizeLabelProvider;
import net.bhl.cdt.ui.e4.parts.explorer.provider.ViewLabelProvider;
...
public class ExplorerViewPart implements ICDTPreferencesListener {
	...
	@PostConstruct
	public void postConstruct(Composite parent, CDTPreferencesService preferencesService,
			ESelectionService selectionService, EPartService partService, ECommandService commandService,
		...
		viewer.addDoubleClickListener(new IDoubleClickListener() {
			...
			public void doubleClick(DoubleClickEvent event) {
				...
				if (selectedElement instanceof File) {
					...
					ParameterizedCommand cmd = commandService.createCommand(E4ResourceIds.COMMAND_OPEN_MODEL_ID,
							params);
	...
	private void createColumns() {
		...
		modifiedColumn.setLabelProvider(
				new DelegatingStyledCellLabelProvider(new FileModifiedLabelProvider(DateFormat.getDateInstance())));
