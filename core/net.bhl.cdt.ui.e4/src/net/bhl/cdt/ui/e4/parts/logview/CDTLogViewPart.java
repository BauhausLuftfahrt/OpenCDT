...
public class CDTLogViewPart implements LogListener {
	...
	logTableViewer.getTable().addListener(SWT.Resize, new Listener() {
	    @Override
		...
		TableColumn resizeCol = table.getColumns()[2];

		resizeCol.setWidth(diff + resizeCol.getWidth());
	    }
	});
	...
	col.setLabelProvider(new ColumnLabelProvider() {
		...
		case LogService.LOG_INFO:
		    return resourceManager.createImage(UIHelper.getImageDescriptor(FrameworkUtil.getBundle(this.getClass()), PluginResources.INFO_ICON));
		case LogService.LOG_ERROR:
		    return resourceManager.createImage(UIHelper.getImageDescriptor(FrameworkUtil.getBundle(this.getClass()), PluginResources.ERROR_ICON));
		case LogService.LOG_WARNING:
		    return resourceManager.createImage(UIHelper.getImageDescriptor(FrameworkUtil.getBundle(this.getClass()), PluginResources.WARNING_ICON));
		case LogService.LOG_DEBUG:
		    return resourceManager.createImage(UIHelper.getImageDescriptor(FrameworkUtil.getBundle(this.getClass()), PluginResources.DEBUG_ICON));
		default:
		    return null;
		}
	    }
