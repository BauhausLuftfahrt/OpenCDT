...
import net.bhl.cdt.calculation.Activator;
 ...
 */
public abstract class AbstractCDTHandler extends AbstractHandler implements IHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		try {
			...
			ErrorDialog.openError(getShell(), "Runtime Exception", "An error has occurred", status);
		}
	...
	/**
	 * This method contains the logic and has to be implemented by classes which extend AbstractCDTHandler.
	 * 
	 * @param event The ExecutionEvent from eclipse
	 * @return A return value if necessary
	 * @throws ExecutionException A standard eclipse exception
	 */
