...
public class FormulaAdapterFactory extends AdapterFactoryImpl {
	...
	protected FormulaSwitch<Adapter> modelSwitch =
		new FormulaSwitch<Adapter>() {
			@Override
			public Adapter caseFormulaRepository(FormulaRepository object) {
				return createFormulaRepositoryAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link formula.FormulaRepository <em>Repository</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createFormulaRepositoryAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link formula.Formula <em>Formula</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
