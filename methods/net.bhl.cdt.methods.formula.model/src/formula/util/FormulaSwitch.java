 ...
 * @generated
 */
public class FormulaSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FormulaPackage.FORMULA_REPOSITORY: {
				FormulaRepository formulaRepository = (FormulaRepository)theEObject;
				T result = caseFormulaRepository(formulaRepository);
	 ...
	 * @generated
	 */
	public T caseFormulaRepository(FormulaRepository object) {
		return null;
	}
