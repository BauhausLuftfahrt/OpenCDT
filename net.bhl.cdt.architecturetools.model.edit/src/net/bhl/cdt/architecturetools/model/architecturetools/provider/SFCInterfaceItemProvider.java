 ...
 * @generated
 */
public class SFCInterfaceItemProvider extends ComponentInterfaceItemProvider
	...
	protected void addSFCParameterPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getResourceLocator(),
				getString("_UI_SFCInterface_SFCParameter_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_SFCInterface_SFCParameter_feature",
						"_UI_SFCInterface_type"),
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/SFCInterface"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_SFCInterface_type")
				: getString("_UI_SFCInterface_type") + " " + label;
	}
